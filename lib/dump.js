...
class Dump {
    ...
    start(obj, t = null) {
        ...
        let dump = isArray ? `${chalk.bold.black('array')} (size=${obj.length}) [\n` : `${chalk.bold.black('object')} (size=${Object.keys(obj).length}) {\n`;
     ...
     */
    isDate(obj) {
        return typeof obj === 'date' ? true : typeof obj === 'object' ? this.objectToString(obj).match(/date/i) !== null : false;
    }
     ...
     */
    isRegExp(obj) {
        return typeof obj === 'function' ? this.objectToString(obj).match(/regexp/i) !== null : false;
    }
